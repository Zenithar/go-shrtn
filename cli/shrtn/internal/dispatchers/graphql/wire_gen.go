...
import (
	...
	v1_2 "go.zenithar.org/shrtn/cli/shrtn/internal/dispatchers/graphql/handlers/v1"
...
func httpServer(ctx context.Context, cfg *config.Configuration, links v1.Link) (*http.Server, error) {
	...
	resolver := v1_2.Resolver(links)
	r.Route("/", func(r chi.Router) {
		r.Handle("/", handler.Playground("GraphQL playground", "/query"))
		r.Handle("/query", handler.GraphQL(v1_2.NewExecutableSchema(v1_2.Config{
			Resolvers: resolver,
		})))
	})
